...
public class CollectionDB {
    ...
    public static Map<Employee, Address> getEmployeeMap(){
        ...
        map.put(new Employee(3, "Elle", 34, 12000.00, List.of("425-423-5355", "324-424-4234")), new Address(111, "Bangalore", 560066, "KA"));
        map.put(new Employee(1, "Ranjan", 36, 12000.00, List.of("312-476-8686", "312-224-7575")), new Address(111, "Bangalore", 560066, "KA"));
        map.put(new Employee(2, "Akash", 32, 23000.00, List.of("767-432-5757", "324-424-4234")), new Address(112, "Mumbai", 123456, "MH"));
        map.put(new Employee(6, "Bikash", 37, 24000.00, List.of("224-545-8678", "224-534-4431")), new Address(113, "Delhi", 324567, "UP"));
        map.put(new Employee(4, "Satish", 38, 26000.00, List.of("132-243-7565", "353-545-7757")), new Address(114, "Pune", 532526, "MH"));
        map.put(new Employee(4, "Satish", 38, 26000.00, List.of("132-243-7565", "353-545-7757")) , new Address(115, "Chennai", 534353, "TN"));
        return map;
    }
}
